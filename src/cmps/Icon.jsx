...
export function SearchLensIcon({ size = 16, color = 'currentColor', title = 'Search lens' }) {
  return (
    <svg
...
export function IconPinned({ size = 16, color = 'currentColor', title = 'Pinned', ...props }) {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
export function IconCheckmark16({ size = 16, color = 'currentColor', title = 'Checkmark' }) {
  return (
    <svg
      role="img"
      aria-hidden="true"
...
export function IconView16({ size = 16, color = 'currentColor', title = 'View' }) {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
// src/cmps/icons/PlayerIcons16.jsx
export function IconShuffle16({ size = 16, color = 'currentColor', title = 'Shuffle', ...rest }) {
  return (
    <svg viewBox="0 0 16 16" width={size} height={size} role="img" aria-label={title} fill={color} {...rest}>
...
export function IconPrev16({ size = 16, color = 'currentColor', title = 'Previous', ...rest }) {
  return (
    <svg viewBox="0 0 16 16" width={size} height={size} role="img" aria-label={title} fill={color} {...rest}>
...
export function IconPlay16({ size = 16, color = 'currentColor', title = 'Play', ...rest }) {
  return (
    <svg viewBox="0 0 16 16" width={size} height={size} role="img" aria-label={title} fill={color} {...rest}>
...
export function IconNext16({ size = 16, color = 'currentColor', title = 'Next', ...rest }) {
  return (
    <svg viewBox="0 0 16 16" width={size} height={size} role="img" aria-label={title} fill={color} {...rest}>
...
export function IconRepeat16({ size = 16, color = 'currentColor', title = 'Repeat', ...rest }) {
  return (
    <svg viewBox="0 0 16 16" width={size} height={size} role="img" aria-label={title} fill={color} {...rest}>
...
// IconPause16.jsx
export function IconPause16({ size = 16, color = 'currentColor', title = 'Pause', ...rest }) {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
// IconVolumeHigh16.jsx
export function IconVolumeHigh16({ size = 16, color = 'currentColor', title = 'Volume high', ...rest }) {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
export function Equalizer({ playing = true, size = 14, color = '#1ed760', title = 'Now playing' }) {
  return (
    <span
      className={`eq ${playing ? 'eq--on' : 'eq--off'}`}
      role="img"
      aria-label={playing ? title : 'Paused'}
      style={{ '--eq-size': `${size}px`, '--eq-color': color }}
    >
      <i /><i /><i />
    </span>
  )
...
export function IconClose16(props) {
  return (
    <svg
      viewBox="0 0 16 16"
      width="16"
...
// Icon.jsx
export function IconPlaylist24(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="24"
...
// Icon.jsx
export function IconEdit24(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="24"
